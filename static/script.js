...
let songs = [
    {
        ...
        artist: "James Arthur",
        album: "Jams Artur",
        albumArtUrl: "https://th.bing.com/th/id/R.ccdc42c45a156691975f40205bbd235c?rik=8lPBobB8xDdfUQ&pid=ImgRaw&r=0",
        audioSrc: "../static/audio/js.mp3",
        videoBgSrc: "../static/videos/james.mp4", // Path video background khusus lagu ini
        // Lirik dengan timestamp dalam detik
     lyrics: [
  { time: 1000, text: "I'm packin' my bags that I didn't unpack the last time" },
  { time: 1000, text: "I'm sayin', \"See you again,\" so many times, it's becoming my tagline" },
  { time:1000, text: "But you know the truth, I'd rather hold you" },
  { time: 1000, text: "Than try to catch this flight" },
  { time: 1000, text: "So many things I'd rather say" },
  { time: 1000.0, text: "But for now, it's goodbye" },
  { time: 1000.0, text: "You say I'm always leavin'" },
  { time: 1000.0, text: "You, when you're sleepin' alone" },
  { time: 1000.0, text: "But the, the car's outside" },
  { time: 1000.0, text: "But I don't wanna go tonight" },
  { time: 1000.0, text: "I'm not gettin' in the Addison Lee" },
  { time: 1000.0, text: "Unless you pack your bags" },
  { time: 1000.0, text: "You're comin' with me" },
  { time: 1000.0, text: "I'm tired of lovin' from afar" },
  { time: 1000.0, text: "And never being where you are" },
  { time: 1000.0, text: "Close the windows, lock the doors" },
  { time: 1000.0, text: "Don't wanna leave you anymore" },
  { time: 1000.0, text: "Oh-oh, ah" },
  { time: 1000.0, text: "I'm starin' at the same four walls in a different hotel" },
  { time: 1000.0, text: "It's an unfamiliar feelin' but I know it so well" },
  { time: 1000.0, text: "Oh, but you know the truth, I'd rather hold you" },
  { time: 1000.0, text: "Than this mobile in my hand" },
  { time: 1000.0, text: "But I guess it'll do, 'cause for you" },
  { time: 1000.0, text: "I would run up my phone bill" },
  { time: 1000.0, text: "You say I'm always leavin'" },
  { time: 1000.0, text: "You, when you need me the most" },
  { time: 1000.0, text: "But the, the car's outside" },
  { time: 1000.0, text: "But I don't wanna go tonight" },
  { time: 1000.0, text: "I'm not gettin' in the Addison Lee" },
  { time: 1000.0, text: "Unless you pack your bags" },
  ...
  { time: 1000.0, text: "Close the windows, lock the doors" },
  { time: 1000.0, text: "Don't wanna leave you anymore" },
  { time: 1000.0, text: "Ooh-ooh, ah" },
  { time: 1000.0, text: "Ooh-ooh, ah" },
  { time: 1000.0, text: "Ooh-ooh, ah" },
  { time: 1000.0, text: "Don't wanna leave you anymore" },
  { time: 1000.0, text: "Oh, darling, all of the city lights" },
  { time: 1000.0, text: "Never shine as bright as your eyes" },
  { time: 1000.0, text: "I would trade them all for a minute more" },
  { time: 1000.0, text: "But the car's outside" },
  { time: 1000.0, text: "And he's called me twice" },
  { time: 1000.0, text: "But he's gonna have to wait tonight" },
  { time: 1000.0, text: "I'm not gettin' in the Addison Lee" },
  { time: 1000.0, text: "Unless you pack your bags" },
  { time: 1000.0, text: "You're comin' with me" },
  { time: 1000.0, text: "I'm tired of lovin' from afar" },
  ...
  { time: 1000.0, text: "Ooh-ooh, ah" },
  { time: 1000.0, text: "Ooh-ooh, ah" },
  { time: 1000.0, text: "No, I don't wanna leave you anymore" },
  { time: 1000.0, text: "(Ooh-ooh, ah) I don't wanna leave you" },
  { time: 1000.0, text: "(Ooh-ooh, ah) I don't wanna leave you" },
  { time: 1000.0, text: "(Ooh-ooh, ah) I don't wanna leave you" },
  { time: 1000.0, text: "Don't wanna leave you anymore" },
]
    ...
    },
    {
        ...
        audioSrc: "../static/audio/Ed Sheeran - Perfect.mp3",
        videoBgSrc: "../static/videos/perfect_bg.mp4", // Path video background khusus lagu ini
        // Lirik dengan timestamp dalam detik
        lyrics: [
    ...
    
    {
        ...
        audioSrc: "../static/audio/Rewrite The Stars - James Arthur feat. Anne Marie.mp3",
        videoBgSrc: "../static/videos/rewrite_the_stars_bg.mp4",
        lyrics: [
   ...
   
    {
        ...
        audioSrc: "../static/audio/I Wanna Be Yours.mp3",
        videoBgSrc: "../static/videos/i_wanna_be_yours_bg.mp4",
        lyrics: [
